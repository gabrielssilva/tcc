...
do Noosfero identificou que esta especificação é a proposta pelo Diaspora \footnote{
as primeiras deliberações a respeito da federação no Noosfero estão registradas no
endereço a seguir
