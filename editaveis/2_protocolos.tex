...
% TODO
% O que é necessário para que um protocolo se torne um padrão?
% como identificar se um protocolo é interoperável?
Ainda no caso da IETF, novos padrões de internet são aceitos apenas mediante prova
técnica de conceito, como demonstração de interoperabilidade entre duas ou mais
implementações distintas \cite{rfc1280}.
...
\subsubsection{Estado do padrão OStatus}

% TODO
% situação de padronização
% parou por que?
