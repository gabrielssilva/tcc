...
% intercomunicação no nível da rede e no nível da aplicação (Comer pag 54)
% observações a respeito do design de redes (Comer pag 55)
...
Um modelo de camadas permite que uma especificação permita a comunicação mesmo entre
